...
public class Spielverwaltung implements NotifyCallback {
	...
	public void retrieved(ID target) {
		if(!SchiffeVersenken.AUSGABE.equals("yes")) System.out.println("==== RETRIEVED (Auf mich wurde geschoßen) ====");
		aktualisiertSpieler();
	...
	public void broadcast(ID source, ID target, Boolean hit) {
		if(!SchiffeVersenken.AUSGABE.equals("yes")) System.out.println("==== BROADCAST (Auf jemanden wurde geschoßen) ====");
